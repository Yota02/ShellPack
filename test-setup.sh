...
# Date de génération : 29/06/2026 10:11:34
# ==============================================================================
...
sudo apt-get update
log_info "Installation des dépendances de base (build-essential, curl, wget, git, unzip, ca-certificates)..."
sudo apt-get install -y build-essential curl wget git unzip ca-certificates software-properties-common gnupg
